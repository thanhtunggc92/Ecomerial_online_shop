...
function CartScreens(){
    ...
    // }
    // This should dispatch the addToCart function as an action and add the item to the cart.
    ...
    return(
        ...
        <Col md={4}>
            <Card>
                <ListGroup variant='flush'>
                    <ListGroup.Item>
                        <h2>Subtotal ({cartItems.reduce((acc, item) => Number(acc + item.qty), 0)}) items</h2>
